...
grulesobj["dnwell"]["active_tap"] = {"min_separation": 0.35}
...
grulesobj["pwell"]["active_tap"] = {"min_enclosure": 0.2}
...
grulesobj["p+s/d"]["active_diff"] = {"min_enclosure": 0.30, "min_separation": 0.13}
grulesobj["p+s/d"]["active_tap"] = {"min_enclosure": 0.18, "min_separation": 0.13}
grulesobj["p+s/d"]["poly"] = {"min_enclosure": 0.30}
...
grulesobj["n+s/d"]["active_diff"] = {"min_enclosure": 0.18, "min_separation": 0.13}
grulesobj["n+s/d"]["active_tap"] = {"min_enclosure": 0.18, "min_separation": 0.13}
...
grulesobj["active_diff"]["poly"] = {"overhang": 0.25, "min_separation": 0.08}
grulesobj["active_diff"]["mcon"] = {"min_enclosure": 0.08}
...
grulesobj["active_tap"]["mcon"] = {"min_enclosure": 0.08}
...
grulesobj["poly"]["mcon"] = {"min_enclosure": 0.1, "min_separation": 0.05}
grulesobj["poly"]["met1"] = {}
grulesobj["poly"]["via1"] = {}
grulesobj["poly"]["met2"] = {}
grulesobj["poly"]["via2"] = {}
...
grulesobj["mcon"]["poly"] = {"min_enclosure": 0.1}
grulesobj["mcon"]["mcon"] = {"min_width": 0.16, "min_separation": 0.18, "width": 0.16}
grulesobj["mcon"]["met1"] = {"min_enclosure": 0.05}
grulesobj["mcon"]["via1"] = {}
grulesobj["mcon"]["met2"] = {}
grulesobj["mcon"]["via2"] = {}
grulesobj["mcon"]["met3"] = {}
...
grulesobj["met1"]["poly"] = {"min_enclosure": 0.05}
grulesobj["met1"]["mcon"] = {}
grulesobj["met1"]["met1"] = {"min_width": 0.16, "min_separation": 0.18, "min_area": 0.09}
grulesobj["met1"]["via1"] = {"min_enclosure": 0.05}
grulesobj["met1"]["met2"] = {}
grulesobj["met1"]["via2"] = {}
grulesobj["met1"]["met3"] = {}
grulesobj["met1"]["via3"] = {}
...
grulesobj["via1"]["poly"] = {}
grulesobj["via1"]["mcon"] = {}
grulesobj["via1"]["met1"] = {"min_enclosure": 0.05}
grulesobj["via1"]["via1"] = {"min_width": 0.19, "min_separation": 0.2, "width": 0.19}
grulesobj["via1"]["met2"] = {"min_enclosure": 0.05}
grulesobj["via1"]["via2"] = {}
grulesobj["via1"]["met3"] = {}
grulesobj["via1"]["via3"] = {}
grulesobj["via1"]["met4"] = {}
...
grulesobj["met2"]["met1"] = {}
grulesobj["met2"]["via1"] = {}
grulesobj["met2"]["met2"] = {"min_width": 0.20, "min_separation": 0.21, "min_area": 0.145}
grulesobj["met2"]["via2"] = {"min_enclosure": 0.05}
grulesobj["met2"]["met3"] = {}
grulesobj["met2"]["via3"] = {}
grulesobj["met2"]["met4"] = {}
grulesobj["met2"]["via4"] = {}
...
grulesobj["via2"]["via1"] = {}
grulesobj["via2"]["met2"] = {}
grulesobj["via2"]["via2"] = {"min_width": 0.19, "min_separation": 0.2, "width": 0.19}
grulesobj["via2"]["met3"] = {"min_enclosure": 0.05}
grulesobj["via2"]["via3"] = {}
grulesobj["via2"]["met4"] = {}
grulesobj["via2"]["via4"] = {}
grulesobj["via2"]["met5"] = {}
...
grulesobj["met3"]["met2"] = {}
grulesobj["met3"]["via2"] = {}
grulesobj["met3"]["met3"] = {"min_width": 0.20, "min_separation": 0.2, "min_area": 0.145}
grulesobj["met3"]["via3"] = {"min_enclosure": 0.05}
grulesobj["met3"]["met4"] = {}
grulesobj["met3"]["via4"] = {}
grulesobj["met3"]["met5"] = {}
...
grulesobj["via3"]["via2"] = {}
grulesobj["via3"]["met3"] = {}
grulesobj["via3"]["via3"] = {"min_width": 0.19, "min_separation": 0.2, "width": 0.19}
grulesobj["via3"]["met4"] = {"min_enclosure": 0.05}
grulesobj["via3"]["via4"] = {}
grulesobj["via3"]["met5"] = {}
...
grulesobj["met4"]["met3"] = {}
grulesobj["met4"]["via3"] = {}
grulesobj["met4"]["met4"] = {"min_width": 0.20, "min_separation": 0.2}
grulesobj["met4"]["via4"] = {"min_enclosure": 0.05}
grulesobj["met4"]["met5"] = {}
...
grulesobj["via4"]["via3"] = {}
grulesobj["via4"]["met4"] = {}
grulesobj["via4"]["via4"] = {"width": 0.19, "min_separation": 0.2}
grulesobj["via4"]["met5"] = {"min_enclosure": 0.05}
...
grulesobj["met5"]["met4"] = {}
grulesobj["met5"]["via4"] = {}
grulesobj["met5"]["met5"] = {"min_width": 0.20, "min_separation": 0.2}
